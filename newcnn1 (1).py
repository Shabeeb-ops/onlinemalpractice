...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\USER\Downloads\archive\train')
    i=-1
    for pa in my_list:

        print(pa,"==================")
        i=i+1
        for root, dirs, files in os.walk(r'C:\Users\USER\Downloads\archive\train\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\USER\Downloads\archive\train\\'+pa, f)
...
# load dataset
x_dataset, y_dataset = read_dataset(r"C:\Users\USER\Downloads\archive\train")
